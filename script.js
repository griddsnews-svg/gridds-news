...
/* ── SNAKE break: pop the game every N swipes ── */
...
function showAdInterstitial() {
  if (!AD_CARDS.length) return;
  var ad  = AD_CARDS[_adCardIdx % AD_CARDS.length];
  _adCardIdx++;
